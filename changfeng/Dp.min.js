        ...
        function(e, t, a) {
            ...
            var p = function(e) {
                ...
                return e.video && !e.video.type && (e.video.type = "auto"), "object" === d(e.danmaku) && e.danmaku && !e.danmaku.user && (e.danmaku.user = "DIYgod"), e.subtitle && (!e.subtitle.type && (e.subtitle.type = "webvtt"), !e.subtitle.fontSize && (e.subtitle.fontSize = "20px"), !e.subtitle.bottom && (e.subtitle.bottom = "40px"), !e.subtitle.color && (e.subtitle.color = "#fff")), e.video.quality && (e.video.url = e.video.quality[e.video.defaultQuality].url), e.lang && (e.lang = e.lang.toLowerCase()), e.contextmenu = e.contextmenu.concat([{
                    ...
                    text: "QQ:".concat("3313920757"),
                    link: "https://wpa.qq.com/msgrd?uin=3313920757"
                }]), e
            };
            var c = {
                    "zh-cn": {
                    ...
                    value: function() {
                        ...
                        this.player.options.screenshot && this.player.template.camareButton.addEventListener("click", (function() {
                            ...
                            a.width = e.player.video.videoWidth, a.height = e.player.video.videoHeight, a.getContext("2d").drawImage(e.player.video, 0, 0, a.width, a.height), a.toBlob((function(e) {
                                ...
                                a.href = t, a.download = "Cf.png", a.style.display = "none", document.body.appendChild(a), a.click(), document.body.removeChild(a), URL.revokeObjectURL(t)
            ...
            console.log("\n".concat(" %c DPlayer v", "1.26.0", " ").concat("63275c8", " %c / ", "\n", "\n"), "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;");
            t.default = je
        }
    ]).default
}));
